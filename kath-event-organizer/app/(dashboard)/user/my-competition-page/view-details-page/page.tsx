  ...
  return (
    <>
      <div className="max-w-6xl mx-auto">
            ...
            {/* Header Card - Moved OUT of grid for full width & better hierarchy */}
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 relative overflow-hidden mb-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {/* Left Column: Main Content - Order 2 on Mobile, Order 1 on Desktop */}
              ...
              {/* Right Column: Sidebar - Order 1 on Mobile (Important!), Order 2 on Desktop */}
                  ...
                  {competition.status === "Finished" ? (
                    ...
                    <>
                      ...
                      <div className="bg-blue-50 p-3 rounded-lg mb-6">
                        ...
                        {lastUpdated && <p className="text-[10px] text-blue-400 mt-1">Last updated: {lastUpdated}</p>}
                      </div>
                      <button 
                      ...
                      <div key={team.id} className="py-3 group flex items-center justify-between">
                        ...
                        {team.name === "KATH Creative" && (
                          <div className="flex flex-col items-end gap-1">
                            ...
                            <Link href="/dashboard-section/user-dashboard/my-team-page" className="flex items-center gap-1 text-[9px] text-gray-400 hover:text-gray-600 transition-colors">
