                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select defaultValue={post.status} className="w-full px-3 py-2 rounded-lg bg-gray-50 border border-gray-200 focus:border-[#a68a2d] outline-none text-sm">
                  ...
                  <div className="space-y-2">
                    {['Insights', 'Tips', 'Case Study', 'News', 'Events'].map((cat) => (
                      <label key={cat} className="flex items-center space-x-2 cursor-pointer">
                        <input type="radio" name="category" defaultChecked={cat === post.category} className="text-[#a68a2d] focus:ring-[#a68a2d]" />
