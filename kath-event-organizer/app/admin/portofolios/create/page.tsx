...
export default function CreatePortfolioPage() {
  ...
  const validate = () => {
    ...
    // Image validation optional for now
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="p-6 md:p-8 border-b border-gray-100">
                ...
                <p className="text-gray-500 text-sm mt-1">Fill in the information below to create a new portfolio item.</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. Grand Wedding Expo"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`block w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#a68a2d]/20 focus:border-[#a68a2d] transition-colors ${errors.client ? 'border-red-300 bg-red-50' : 'border-gray-200'}`}
                      placeholder="e.g. Cakrawala University"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={formData.date}
                      onChange={handleChange}
                      className={`block w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#a68a2d]/20 focus:border-[#a68a2d] transition-colors ${errors.date ? 'border-red-300 bg-red-50' : 'border-gray-200'}`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`block w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#a68a2d]/20 focus:border-[#a68a2d] transition-colors ${errors.categories ? 'border-red-300 bg-red-50' : 'border-gray-200'}`}
                      placeholder="e.g. Wedding, Exhibition (comma separated)"
                    />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className={`block w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-[#a68a2d]/20 focus:border-[#a68a2d] transition-colors ${errors.description ? 'border-red-300 bg-red-50' : 'border-gray-200'}`}
                ...
                <div className="flex items-center justify-end gap-4 pt-4 border-t border-gray-100">
                  ...
                  <button
                    ...
                    className={`flex items-center px-6 py-2.5 bg-[#a68a2d] text-white rounded-lg font-medium shadow-md shadow-[#a68a2d]/20 hover:bg-[#8c7324] transition-all ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                  >
